...
if(ix_neigh<L1){
HopMat[site_neigh + OY*L1*L2][site + OY*L1*L2]=thop*txz_x_by_txy;
HopMat[site_neigh + OZ*L1*L2][site + OZ*L1*L2]=thop;
HopMat[site + OY*L1*L2][site_neigh + OY*L1*L2]=thop*txz_x_by_txy;
...
site_neigh= ix_neigh + iy_neigh*L1;
if(iy_neigh<L2){
HopMat[site_neigh + OX*L1*L2][site + OX*L1*L2]=thop*txz_x_by_txy;
HopMat[site_neigh + OZ*L1*L2][site + OZ*L1*L2]=thop;
HopMat[site + OX*L1*L2][site_neigh + OX*L1*L2]=thop*txz_x_by_txy;
HopMat[site + OZ*L1*L2][site_neigh + OZ*L1*L2]=thop;
}
