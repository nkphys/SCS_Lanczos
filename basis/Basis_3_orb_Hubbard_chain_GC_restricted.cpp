...
#include <iostream>
#include <math.h>
#include "Basis_3_orb_Hubbard_chain_GC_restricted.h"
using namespace std;
...
void BASIS_3_orb_Hubb_chain_GC_Restricted::Construct_basis(){
    Restricted=true;
...
void BASIS_3_orb_Hubb_chain_GC_Restricted::clear(){
    D_up_basis.clear();
    D_dn_basis.clear();
}
