...
#ifndef Basis_Spins_Target_PartialSz_and_LatticeSym
#define Basis_Spins_Target_PartialSz_and_LatticeSym
class BASIS_Spins_Target_PartialSz_and_LatticeSym{

public:
    int Length;
    Mat_1_int TwoTimesSpin;
    double Target_Total_Sz;
    Mat_1_int SitesSzTarget;
