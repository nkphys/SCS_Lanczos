...
#ifndef Model_multi_orb_Hubb_chain_GC_class
#define Model_multi_orb_Hubb_chain_GC_class

template <typename Basis_type>
class MODEL_multi_orb_Hubb_chain_GC{

public:
    MODEL_multi_orb_Hubb_chain_GC(Basis_type& Basis_)
        : basis(Basis_)
    {
    }
    ...
    void Initialize_one_point_to_calculate_5orbs();
    void Initialize_two_point_to_calculate();
    void Initialize_Opr_for_Dynamics();
    void Run_SingleSite_5orb_NonInteracting();
    ...
    void Get_c_on_GS(Mat_1_doub &EigVec_, BASIS_multi_orb_Hubb_chain_GC & basis_Nm1,
                     Mat_1_trio_int TRIO_VEC, Mat_1_doub values);
    void Get_cdagger_on_GS(Mat_1_doub &EigVec_, BASIS_multi_orb_Hubb_chain_GC & basis_Np1,
                     Mat_1_trio_int TRIO_VEC, Mat_1_doub values);
